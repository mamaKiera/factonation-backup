       ...
       <div className="flex justify-between items-center gap-12">
        <div className="flex flex-col w-6/12 gap-7 ">
            ...
            <div className="flex gap-8 text-2xl items-center">
                <Button size={'xl'} className="px-8 bg-black text-white">สมัครทันที</Button>
                <Button size={'xl'} variant={'outline'}>แนะนำคอร์ส</Button>
            </div>
        </div>
        <div>
            <Image src={heroImage} alt='hero image'style={{height:350,width:455}} className="flex items-center rounded-xl"/>
        </div>
       </div>
     </div>
        </div>
